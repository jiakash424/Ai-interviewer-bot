...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // For demo/hackathon — just redirect to interview
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center gap-2 py-3 rounded-xl bg-slate-700/30 border border-slate-600/50 text-sm text-slate-300 hover:bg-slate-700/50 hover:border-slate-500 transition-all"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-slate-800/40 text-slate-500">or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className="w-full mt-2 py-3.5 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-shadow flex items-center justify-center gap-2"
            >
